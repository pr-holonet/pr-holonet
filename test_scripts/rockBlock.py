...
class rockBlock(object):
        ...
        try:
            ...
            if( self._configurePort() ):
                ...
                if( self.ping() ):
                    ...
                    if(self.callback != None and isinstance(self.callback.rockBlockConnected, collections.Callable) ):   
    ...
    def messageCheck(self):
        ...
        if(self.callback != None and isinstance(self.callback.rockBlockRxStarted, collections.Callable) ):
        ...
        if( self._attemptConnection() and self._attemptSession() ):
            ...
            if(self.callback != None and isinstance(self.callback.rockBlockRxFailed, collections.Callable) ):
    ...
    def sendMessage(self, msg):
        ...
        if(self.callback != None and isinstance(self.callback.rockBlockTxStarted, collections.Callable) ):
        ...
        if(self.callback != None and isinstance(self.callback.rockBlockTxFailed, collections.Callable) ):
            ...
            if( self.s.readline().strip() == command ):
                ...
                if( response.find("+SBDIX:") >= 0 ):
                    ...
                    if(moStatus <= 4):
                        ...
                        if(self.callback != None and isinstance(self.callback.rockBlockTxSuccess, collections.Callable) ):   
                    ...
                    if(self.callback != None and isinstance(self.callback.rockBlockRxMessageQueue, collections.Callable) ): 
    ...
    def _attemptConnection(self):
        ...
        while True:
            ...
            if(TIME_ATTEMPTS == 0):
                ...
                if(self.callback != None and isinstance(self.callback.rockBlockSignalFail, collections.Callable) ): 
        ...
        while True:
            ...
            if( signal >= SIGNAL_THRESHOLD ):
                ...
                if(self.callback != None and isinstance(self.callback.rockBlockSignalPass, collections.Callable) ): 
    ...
    def _processMtMessage(self, mtMsn):
        ...
        if( response == "OK" ):
            ...
            if(self.callback != None and isinstance(self.callback.rockBlockRxReceived, collections.Callable) ): 
